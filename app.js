...
function runSplash(){const s=$('#splash');if(!s)return;document.body.classList.add('splashing');requestAnimationFrame(()=>s.classList.add('play'));setTimeout(()=>s.classList.add('leave'),1850);setTimeout(()=>{s.remove();document.body.classList.remove('splashing')},2350)}
